    ...
    <style>
        ...
        * {
        ...
        .form-box {
            ...
            position: relative; /* Penting untuk posisi tombol X */
        }

        /* Gaya baru untuk Tombol X */
        .close-btn {
            position: absolute;
            top: 20px;
            right: 20px;
        ...
        /* Gaya khusus tombol kembali di bawah */
        .btn-back {
            border-color: #444;
            color: #bbb;
            margin-top: 10px;
...
<div class="container">
    <div class="form-box">
        <a href="{{ route('lapangan.index') }}" class="close-btn">&times;</a>
